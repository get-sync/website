...
import startupHero from "../assets/startupHero.svg";

import { motion } from "framer-motion";

const StartupHero = ({ handleImageLoad, isLoaderDone }) => {
  return (
    <div className="h-[68vh] w-full ">
      ...
      <header className="pt-[90px] pl-[7%] s:pl-[10%] pr-[5px] md:px-[100px] h-full mx-auto">
        <div className="flex justify-between py-[60px] h-full items-center">
          ...
          >
            <div>
              <h2 className="text-[25px] xs:text-[28px] sm:text-[32px] md:text-[36px] big:text-[40px] lg:text-[44px] xl:text-[48px] font-helvetica font-bold leading-[35px] md:leading-[40px] lg:leading-[50px] xl:leading-[58px]">
                Say goodbye to
                <br />{" "}
                <span className="text-[#FFED48]">recruitment headaches</span> !
              </h2>
              <p className="mt-1 text-[13px] md:text-[14px] big:text-[16px] lg:text-[18px] xl:text-[20px] font-cabin italic leading-[24px] w-[75%]">
                Streamline your intern hiring process, save time, and find the
                best talent for free
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p className="font-helvetica text-[#FFED48] text-[12px] md:text-[14px] lg:text-[16px]">
                Or Join <span className="underline">Founders' Community</span>
              </p>
            </div>
          </motion.div>
